...
- Όταν ο χρήστης και η αγγελία είναι και οι δύο στη Ρόδο, εμφανίζεται πρόταση ασφαλούς συνάντησης: **iRepair Ρόδος - Αμμοχώστου 18**
- Αν ο χρήστης δεν έχει επιλέξει πόλη, εμφανίζεται μήνυμα για επιλογή
