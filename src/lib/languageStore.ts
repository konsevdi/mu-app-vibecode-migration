...
export const translations = {
  el: {
    ...
    condition_new_desc: "Αχρησιμοποίητο, στην αρχική συσκευασία",
    condition_like_new_desc: "Ελάχιστη χρήση, άριστη κατάσταση",
    condition_good_desc: "Μικρά σημάδια χρήσης",
    condition_fair_desc: "Φανερή χρήση, πλήρως λειτουργικό",
    condition_parts_desc: "Για ανταλλακτικά μόνο",
    // Sell
    ...
    // Listing Detail
    listing_not_found: "Η αγγελία δεν βρέθηκε",
    report_submitted: "Αναφορά υποβλήθηκε",
    report_submitted_desc: "Ευχαριστούμε για την αναφορά. Θα εξετάσουμε την αγγελία.",
    report_listing: "Αναφορά αγγελίας",
    report_confirm: "Θέλετε να αναφέρετε αυτή την αγγελία;",
    ...
    morning: "ΠΡΩΙ",
    afternoon: "ΑΠΟΓΕΥΜΑ",
    diagnostic_info: "Διαγνωστικό τέλος €10 (επιστρέφεται αν αγοράσεις)",
    ...
    safety_tip_1: "Συναντήσου πάντα σε δημόσιο χώρο",
    safety_tip_2: "Χρησιμοποίησε τα καταστήματα iRepair για ασφαλείς συναντήσεις",
    safety_tip_3: "Έλεγξε τη συσκευή πριν πληρώσεις",
    safety_tip_4: "Μην πληρώνεις ποτέ εκ των προτέρων",
    safety_tip_5: "Αν κάτι φαίνεται πολύ καλό για να είναι αληθινό, πιθανότατα δεν είναι",
    // Auth
    ...
    or_continue_with: "ή συνέχισε με",
    // Assistant
    assistant_title: "Βοηθός",
    assistant_subtitle: "Οδηγός αγορών",
    thinking: "Σκέφτομαι...",
    type_message: "Γράψε μήνυμα...",
    suggestions: "ΠΡΟΤΑΣΕΙΣ",
    hi_how_can_i_help: "Γεια! Πώς μπορώ να βοηθήσω;",
    ask_about: "Ρώτα με για τιμές, συσκευές ή ασφάλεια",
    open_assistant: "Άνοιξε τον βοηθό",
    close: "Κλείσιμο",
    send: "Αποστολή",
    // Tab Labels
    tab_home: "ΑΡΧΙΚΗ",
    ...
    home_subtitle: "Αγόρασε και πούλησε συσκευές στη Ρόδο",
